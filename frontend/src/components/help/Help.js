...
const Settings = () => (
  <Box pad='large' align='start' justify='start' gap='large' flex={false}> 
    <Box gap='small' flex={false}>
      ...
      <Anchor href='https://github.com/openservicebrokerapi/servicebroker/blob/master/spec.md' label='OSB Specification' size='xlarge' color='brand' />
      <Anchor href='https://www.openservicebrokerapi.org' label='OSB Information' size='xlarge' color='brand' />
